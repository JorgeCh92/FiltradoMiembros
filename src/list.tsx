...
export const ListPage: React.FC = () => {
  ...
  const [filterOrganization, setFilterOrganization]= React.useState("Lemoncode");

  const [fullUserCollection]= React.useState(React.useEffect(() => {
  ...
  if(filterOrganization.toUpperCase() == "LEMONCODE")
  {
    return (
      <>
        ...
        <div>
          ...
          <input type="button" value="Filtrar por organización"
            onClick={(e) => setFilterOrganization(organization)}/>
        </div>
  ...
  else if(filterOrganization.toUpperCase() == "MICROSOFT")
  {
    return (
      <>
        <h2>Hello from List page</h2>
